#!/usr/bin/env sh
# Universal installer for semsift. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/semsift.git"
echo "Installing semsift ..."
