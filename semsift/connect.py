"""Native cognis-connect emit for semsift — forward findings to any platform.

Maps semsift's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    semsift ... --format json | semsift-emit --to stix
    semsift-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
